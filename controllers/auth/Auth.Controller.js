...
export const signUp = async (req, res) => {
    ...
    const { first_name, last_name, country, city, postal_code, birthdate, email, password } = req.body;
...
export const getUserData = async (req, res) => {
    ...
    const employee = await Employee.findOne({ where: { id: decoded.id }, include: { model: EmployeeMobile, attributes: ["mobile_no"] } });
